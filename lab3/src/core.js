...
function getOperationFn(initialValue, operatorFn) {
    // Если operatorFn не задан, возвращаем функцию, которая всегда возвращает initialValue
    if (typeof operatorFn !== 'function') {
        return () => initialValue;
    }

    // Возвращаем функцию, которая применяет operatorFn к текущему значению и новому значению
